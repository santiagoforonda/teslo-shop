...
const CustomHeader = () => {
    ...
    const handleSearch =(event: KeyboardEvent<HTMLInputElement>)=>{
      ...
      if(!query){
        ...
        newSearchParams.set("query",input.current!.value);
      }
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden md:flex items-center space-x-2">
              <div className="relative">
                ...
                <Input placeholder="Buscar productos..." className="pl-9 w-64 h-9 bg-white" ref={input} onKeyDown={handleSearch} defaultValue={query} />
              </div>
            </div>
