                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        {
                                            errors.price && (
                                                <p className='text-red-500 text-sm'>El precio debe ser mayor a 1</p>
                                            )
                                        }
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {
                                            errors.stock && (
                                                <p>El stock del producto debe ser mayor a 1</p>
                                            )
                                        }
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        {...register("slug",{
                                            required:true,
                                            validate:(value)=>{
                                                return !/\s/.test(value) || "El slug no puede contener espacios en blanco"
                                            }
                                        })}
